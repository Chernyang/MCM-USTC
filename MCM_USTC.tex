...
\begin{document}
	...
	\begin{figure}[H]
		...
		\caption{sales of hair dryers} \label{hair dryer sales}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{sales of microwave oven} \label{microwave sales}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{sales of baby pacifier} \label{pacifier sales}
	\end{figure}
	...
	\begin{figure}[H]
		\begin{minipage}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.65]{pacifier_advantage.eps}
			\caption{The proportion of reasons people like the baby pacifier\label{fig:1}}
		\end{minipage}
		\qquad
		\begin{minipage}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.65]{pacifier_disadvantage.eps}
	...
	\begin{figure}[H]
		\begin{minipage}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.65]{hair_dryer_advantage.eps}
			\caption{The proportion of reasons people like the hair dryer}
		\end{minipage}
		\qquad
		\begin{minipage}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.65]{hair_dryer_disadvantage.eps}
	...
	\begin{figure}[H]
		\begin{minipage}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.65]{microwave_advantage.eps}
			\caption{The proportion of reasons people like the microwave oven\label{fig:1}}
		\end{minipage}
		\qquad
		\begin{minipage}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.65]{microwave_disadvantage.eps}
	...
	\begin{table}[H]
		\centering
		\caption{The number of times the word appears}
	...
	\begin{figure}[H]
		\begin{minipage}[t]{1\textwidth}
			\centering
			\includegraphics[width=16cm]{total.eps}
			\caption{probability of words in high/low rating comments\label{fig:1}}
		\end{minipage}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{average rating of hair dryer} \label{fig:hair dryer average rating}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{average rating of microwave oven} \label{fig:micorwave average rating}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{average rating of baby pacifier} \label{fig:pacifier average rating}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{total score for hair dryer} \label{fig:hair dryer total score}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{total score for microwave oven} \label{fig:microwave total score}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{total score for baby pacifier} \label{fig:pacifier total score}
	\end{figure}
