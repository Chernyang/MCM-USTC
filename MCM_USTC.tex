...
\begin{document}
	...
	\begin{figure}[H]
		\small
		\centering
		\includegraphics[width=15cm]{hair_dryer_total_score.eps}
	...
	\begin{figure}[H]
		\small
		\centering
		\includegraphics[width=15cm]{microwave_total_score.eps}
	...
	\begin{figure}[H]
		\small
		\centering
		\includegraphics[width=15cm]{pacifier_total_score.eps}
	...
	在这篇论文中，我们使用了多种处理方式，主要分析了目前市场上已有产品的销量及用户反馈。
